# AI Knowledge & Interaction Platform – LinkedIn Carousel Design Template Final
...
┌─────────────────────────────────────┐  ─┐
│                                     │   │
│  [Logo] AI Knowledge &              │   │ VIERTEL 1
│         Interaction Platform  1/8   │   │ Header (337px)
│                                     │   │
├─────────────────────────────────────┤  ─┤
│                                     │   │
│  Label                              │   │
...
|---------|------|-------|---------|-------|
| **Logo-Text** | Rubik | 24px | 700 | Gradient |
...
```
[Logo-Icon 72px] + [18px Gap] + [AI Knowledge & Interaction Platform 24px Gradient]
```
...
```
carousel-template\
├── TEMPLATE-carousel-final.html  ← Master-Template Final (HTML)
├── TEMPLATE-carousel-final.pdf   ← Beispiel-Export Final (PDF)
├── TEMPLATE-SPECS-final.md       ← Diese Dokumentation (Final)
├── convert.py                    ← Konvertierungsscript
├── fonts/                        ← Schriftarten
...
### Final (09.02.2026)
- Finalisierte Version des Templates
- Logo-Text: `AI Knowledge & Interaction Platform` (24px)
- Basiert auf V2 mit bereinigten Dateinamen und Referenzen

### V2 (06.02.2026)
- Logo-Text geändert: `AI-KIP` → `AI Knowledge & Interaction Platform`
- Logo-Text Schriftgröße reduziert: 36px → 24px (für längeren Namen)
